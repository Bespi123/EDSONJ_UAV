...
#    for i in range(1,16):
    ...
    sql = "INSERT INTO Vectors (yaw, pitch, roll, latitude, longitude, altitude, velocityx, velocityy, velocityz, accelx, accely, accelz, angularratex, angularratey, angularratez, time, time2) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)"
    valv = (v1,v2,v3,v4,v5,v6,v7ned,v8ned,v9ned,v10,v11,v12,v13,v14,v15,MeasureTime,MeasureTime2)
