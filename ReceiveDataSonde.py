...
if client.connect():
    ...
    while True:
        ...
        sql="INSERT INTO Sensors (temperature, pressure, depth, depthw, surface, conductivitya, conductivitys, resistivity, salinity, solidsd, waterd, pressureb, ph, phmv, orp, concetrationo, saturationo, pressureo, voltage, battery, time, time2) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)"
        val=(s1,s2,s3,s4,s5,s6,s7,s8,s9,s10,s11,s12,s13,s14,s15,s16,s17,s18,s19,s20,MeasureTime,MeasureTime2)
